...
class NumpyArrayWrapper:
    ...
    * writing the array bytes to a file.
    ...
    def read(self, unpickler, ensure_native_byte_order): # -> Any:
...
def load_temporary_memmap(filename, mmap_mode, unlink_on_gc_collect): # -> Any:
    ...

def load(filename, mmap_mode=..., ensure_native_byte_order=...): # -> Any:
