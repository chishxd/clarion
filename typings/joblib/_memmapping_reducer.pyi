...
def reduce_array_memmap_backward(a): # -> tuple[Callable[..., Any], tuple[Any, Any, Any, Any, str, Any, Any | None, Any | None, bool]] | tuple[Callable[..., Any], tuple[bytes]]:
...
class ArrayMemmapForwardReducer:
    ...
    def __call__(self, a): # -> tuple[Callable[..., Any], tuple[Any, Any, Any, Any, str, Any, Any | None, Any | None, bool]] | tuple[Callable[..., Any], tuple[str, Any, Any]] | tuple[Callable[..., Any], tuple[bytes]]:
        ...
